...
const NotificationDropdown = ({ apiUrl = '/api', currentUser }) => {
  ...
  // Obtenir le token d'authentification (à adapter selon votre implémentation)
  const getAuthToken = () => {
    // Si vous utilisez un contexte ou des props pour le token
    // return authToken;
    // Sinon, adapter selon votre système d'authentification
