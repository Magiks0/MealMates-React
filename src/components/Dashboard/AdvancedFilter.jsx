...
const AdvancedFilter = ({ isOpen, onClose }) => {
  ...
  useEffect(() => {
    ...
    return (
    <div className={`fixed top-0 right-0 bottom-16 bg-white w-80 shadow-xl transform transition-transform duration-300 ease-in-out z-50 flex flex-col ${isOpen ? 'translate-x-0' : 'translate-x-full'}`}>
